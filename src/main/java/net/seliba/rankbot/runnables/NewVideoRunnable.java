        ...
        try {
            ...
            while (true) {
                ...
                if (!latestVideoId.equalsIgnoreCase(videoData)) {
                    ...
                    sendMessage(jda.getTextChannelById(486571558748553219L), ":tada: WOOOOOHOOOO!  @everyone! :tada:\n"
                            + "\n"
                            + "BiVieh hat ein neues Video hochgeladen! :tv:\n"
                            + "Viel Spaß!\n"
                            + "https://www.youtube.com/watch?v=" + videoData + "\n"
                            + "\n"
                ...
                Files.write(Paths.get(videoFile.toURI()), Collections.singletonList(latestVideoId), Charset.forName("UTF-8"));
